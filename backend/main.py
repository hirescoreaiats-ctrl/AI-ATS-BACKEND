...
from backend.api import ai, copilot, debug, demo, enterprise, health, help, interviews, organizations, realtime, support, talent, uploads
...
def ensure_resume_columns():
    ...
    with engine.begin() as connection:
        ...
        add_column("resumes", resume_columns, "manual_overrides_json", "TEXT")
        ...
        add_column("resumes", resume_columns, "ranking_version", "INTEGER DEFAULT 0")
        add_column("resumes", resume_columns, "ranking_updated_at", datetime_definition)
