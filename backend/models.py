...
class Resume(Base):
    ...
    profile_extraction_quality = Column(String, nullable=True)
    raw_parsed_json = Column(Text, nullable=True)
    ...
    resume_file_key = Column(Text, nullable=True)
...
class User(Base):
    ...
    outreach_sender_verified_at = Column(DateTime, nullable=True)
    outreach_sender_verification_token = Column(String, nullable=True, index=True)
    outreach_sender_verification_expires_at = Column(DateTime, nullable=True)
    outreach_smtp_host = Column(String, nullable=True)
    outreach_smtp_port = Column(Integer, nullable=True)
    outreach_smtp_username = Column(String, nullable=True)
    outreach_smtp_password_enc = Column(Text, nullable=True)
    outreach_smtp_use_tls = Column(Boolean, default=True)
