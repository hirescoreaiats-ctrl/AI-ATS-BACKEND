...
def enrich_jd_for_scoring(jd_text: str, job_data: dict | None = None, structured_jd: dict | None = None) -> dict:
    ...
    return {
        ...
        "detected_role_family": profile.get("detected_role_family"),
        "role_family_confidence": profile.get("role_family_confidence"),
        "scoring_mode": profile.get("scoring_mode"),
        "dynamic_profile_used": profile.get("dynamic_profile_used"),
        "known_template_used": profile.get("known_template_used"),
        "jd_profile_version": profile.get("jd_profile_version"),
        "normalized_role_label": profile.get("normalized_role_label"),
        "profile_confidence": profile.get("profile_confidence"),
        "profile_warnings": profile.get("profile_warnings") or [],
