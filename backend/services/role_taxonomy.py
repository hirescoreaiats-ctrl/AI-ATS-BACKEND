...
ROLE_FAMILIES = {
    ...
    "aml_transaction_monitoring": {
        "patterns": [
            r"\baml\s+transaction\s+monitoring\s+(?:investigator|analyst|specialist|officer)\b",
            r"\btransaction\s+monitoring\s+(?:investigator|analyst|specialist|officer)\b",
            r"\baml\s+(?:case\s+)?investigator\b",
            r"\bfinancial\s+crime\s+investigator\b",
            r"\baml\s+investigation(?:s)?\b",
            r"\baml\s+alerts?\b",
        ...
        "skills": [
            "AML Transaction Monitoring", "Transaction Monitoring", "AML Alerts",
            "Escalated Alerts", "Alert Investigation", "AML Investigations",
            "Case Investigation", "Case Management", "Suspicious Activity",
            "Suspicious Transaction", "Money Laundering", "Financial Crime",
            "SAR", "STR", "Suspicious Activity Report", "Suspicious Transaction Report",
            "Retail Banking", "Commercial Banking", "Correspondent Banking",
            "Case Narrative", "Regulatory Reporting",
        ],
        "default_must_have": [
            "AML Transaction Monitoring", "AML Investigations", "Case Management",
            "SAR", "STR", "Retail Banking", "Commercial Banking",
            "Correspondent Banking", "Case Narrative",
        ],
        "default_core_groups": {
            "role_fit": ["AML Transaction Monitoring Investigator", "AML Investigator", "Transaction Monitoring Investigator", "AML Case Investigator", "Financial Crime Investigator", "Senior AML Analyst"],
            "transaction_monitoring": ["AML Transaction Monitoring", "Transaction Monitoring", "TM Alerts", "AML Alerts", "Monitoring Alerts", "Alert Investigation", "Transaction Review", "Suspicious Transaction Monitoring"],
            "aml_investigations": ["AML Investigation", "AML Investigations", "Case Investigation", "Financial Crime Investigation", "Money Laundering Investigation", "Suspicious Activity Investigation", "Suspicious Transaction Investigation"],
            "case_management": ["Case Management", "Case Handling", "Case Review", "Case Disposition", "Case Closure", "Alert Closure", "Investigation Workflow", "Case Narrative"],
            "sar_str": ["SAR", "STR", "Suspicious Activity Report", "Suspicious Transaction Report", "SAR Filing", "STR Filing", "SAR Documentation", "STR Documentation", "Regulatory Reporting"],
            "banking_exposure": ["Retail Banking", "Commercial Banking", "Correspondent Banking", "Banking", "Financial Institution", "BFSI"],
            "nice_to_have": ["KYC", "CDD", "EDD", "Customer Due Diligence", "Enhanced Due Diligence", "Source of Funds", "Source of Wealth", "Adverse Media", "PEP Screening", "Sanctions Screening", "Smurfing", "Layering", "Structuring", "Money Mule", "Shell Company", "Round Tripping", "Terrorist Financing", "US AML", "International AML"],
        },
        "default_nice_to_have": [
