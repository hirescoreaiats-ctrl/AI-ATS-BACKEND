...
ROLE_FAMILIES = {
    "software_backend": {
        ...
        "skills": ["Python", "Java", "Node.js", "FastAPI", "Django", "Flask", "Spring Boot", "SQL", "PostgreSQL", "MySQL", "REST API"],
        "core_groups": {
            "language": ["Python", "Java", "JavaScript", "Node.js", "C#"],
            "framework": ["FastAPI", "Django", "Flask", "Spring Boot", "Express"],
