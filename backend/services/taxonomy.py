...
SKILL_SYNONYMS = {
    ...
    "real-time systems": "Real-time Systems",
    "real time firmware": "Real-time Firmware",
    "real-time firmware": "Real-time Firmware",
    ...
    "o365": "Office 365",
    "microsoft 365 migration": "Microsoft 365 Migration",
    "m365 migration": "Microsoft 365 Migration",
    "office 365 migration": "Office 365 Migration",
    "o365 migration": "Office 365 Migration",
    "tenant to tenant migration": "Tenant-to-Tenant Migration",
    "tenant-to-tenant migration": "Tenant-to-Tenant Migration",
    "t2t migration": "Tenant-to-Tenant Migration",
    "cross tenant migration": "Cross-tenant Migration",
    "cross-tenant migration": "Cross-tenant Migration",
    "exchange online migration": "Exchange Online Migration",
    "exo migration": "Exchange Online Migration",
    "on prem exchange migration": "On-Prem Exchange Migration",
    "on-prem exchange migration": "On-Prem Exchange Migration",
    "exchange on premises migration": "On-Prem Exchange Migration",
    "exchange server migration": "On-Prem Exchange Migration",
    "exchange online": "Exchange Online",
    "exo": "Exchange Online",
    "exchange server": "Exchange Server",
    "hybrid exchange": "Hybrid Exchange",
    "teams migration": "Teams Migration",
    "sharepoint migration": "SharePoint Migration",
    "onedrive migration": "OneDrive Migration",
    "workload migration": "Workload Migration",
    "mailbox migration": "Mailbox Migration",
    ...
    "quest odm": "Quest ODM",
    "quest on demand migration": "Quest On Demand Migration",
...
TRANSFERABLE_GROUPS = [
    {"Firmware", "Embedded Firmware", "Embedded Software", "Embedded Systems"},
    {"RTOS", "Real-time Systems", "Real-time Firmware"},
...
SKILL_CATEGORIES = {
    ...
    "Real-time Firmware": "Embedded",
    "Printed Circuit Board": "Hardware",
    "Hardware/Software Integration": "Embedded",
    "Electronic Schematics": "Hardware",
...
KNOWN_SKILL_PATTERNS = [
    ("C++", re.compile(r"(?<![\w+#])c\s*\+\+(?!\w)|\bcpp\b", re.I)),
    ("C", re.compile(r"(?<![\w+#])c(?![\w+#])(?=\s*(?:programming|language|development|firmware|,|/|&|\.|$))", re.I)),
    ("Embedded Firmware", re.compile(r"\bembedded\s*(?:firmware|fw)\b|\bembedded\s*hw\s*and\s*fw\b", re.I)),
