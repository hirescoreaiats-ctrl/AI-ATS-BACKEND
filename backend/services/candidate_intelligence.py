...
def resume_intelligence_payload(candidate):
    ...
    return {
        ...
        "missing_critical_skills": from_json_text(getattr(candidate, "missing_critical_skills", None), []),
        "matched_critical_skills": from_json_text(getattr(candidate, "matched_critical_skills", None), []),
        "shortlist_decision": getattr(candidate, "shortlist_decision", None),
        "decision_reason": getattr(candidate, "decision_reason", None),
        "recruiter_explanation": getattr(candidate, "recruiter_explanation", None),
        "strengths": from_json_text(getattr(candidate, "strengths", None), []),
        "concerns": from_json_text(getattr(candidate, "concerns", None), []),
        "score_breakdown": from_json_text(getattr(candidate, "score_breakdown", None), {}),
        "parser_confidence": getattr(candidate, "parser_confidence", None),
        "parser_warnings": from_json_text(getattr(candidate, "parser_warnings", None), []),
        "ai_parse_status": getattr(candidate, "ai_parse_status", None),
        "extraction_quality_score": getattr(candidate, "extraction_quality_score", None),
        "low_confidence_fields": from_json_text(getattr(candidate, "low_confidence_fields", None), []),
        "cap_reason": getattr(candidate, "cap_reason", None),
        ...
        "jd_profile_version": scoring_breakdown.get("jd_profile_version"),
        "scoring_mode": scoring_breakdown.get("scoring_mode"),
        "dynamic_profile_used": scoring_breakdown.get("dynamic_profile_used"),
        "known_template_used": scoring_breakdown.get("known_template_used"),
        "detected_role_family": scoring_breakdown.get("detected_role_family"),
        "normalized_role_label": scoring_breakdown.get("normalized_role_label"),
        "profile_confidence": scoring_breakdown.get("profile_confidence"),
        "profile_warnings": scoring_breakdown.get("profile_warnings") or [],
        "role_alignment": scoring_breakdown.get("role_alignment"),
        "role_alignment_reason": scoring_breakdown.get("role_alignment_reason"),
        "applied_caps": scoring_breakdown.get("applied_caps") or from_json_text(getattr(candidate, "score_caps_applied", None), []),
        "applied_boosts": scoring_breakdown.get("applied_boosts") or [],
        "final_score_after_caps": scoring_breakdown.get("final_score_after_caps") or getattr(candidate, "final_score", None),
        ...
        "recent_relevant_experience_years": scoring_breakdown.get("recent_relevant_experience_years"),
        "experience_dates_considered": scoring_breakdown.get("experience_dates_considered") or [],
        "requirement_coverage": scoring_breakdown.get("requirement_coverage") or {},
        "mandatory_checks": scoring_breakdown.get("mandatory_checks") or [],
        "mandatory_constraint_status": scoring_breakdown.get("mandatory_constraint_status"),
        "experience_alignment": scoring_breakdown.get("experience_alignment"),
        "experience_alignment_score": scoring_breakdown.get("experience_alignment_score"),
        "overall_recruiter_fit_score": scoring_breakdown.get("overall_recruiter_fit_score"),
